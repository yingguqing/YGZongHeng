...
class ScanCodeController: UIViewController {
    ...
    fileprivate func setupScanView() {
        ...
        scanImageView = UIImageView(image: #imageLiteral(resourceName: "sweep_bg_line"));
        let widthOrHeight: CGFloat = 18
        
        let topLeft = UIButton(frame: CGRect(x: 0, y: 0, width: widthOrHeight, height: widthOrHeight))
        topLeft.setImage(#imageLiteral(resourceName: "sweep_kuangupperleft"), for: .normal)
        ...
        topRight.setImage(#imageLiteral(resourceName: "sweep_kuangupperright"), for: .normal)
        ...
        bottomLeft.setImage(#imageLiteral(resourceName: "sweep_kuangdownleft"), for: .normal)
        ...
        bottomRight.setImage(#imageLiteral(resourceName: "sweep_kuangdownright"), for: .normal)
